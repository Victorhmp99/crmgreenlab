...
import { CalendarClock, CheckSquare, MessageSquare, UserRound } from 'lucide-react'
...
export function BoardCardView({ card, labels, membros, onOpen, overlay = false }: Props) {
  ...
  return (
    ...
    >
      <div className="rounded-lg" style={{ background: '#161616', border: '1px solid #242424' }}>
        ...
        <div className="p-2.5 flex flex-col gap-2">
          ...
          <p className={cn('text-sm leading-snug', concluido && 'line-through')}
             style={{ color: concluido ? '#666' : '#e8e8e8' }}>{card.title}</p>
